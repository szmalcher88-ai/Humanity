...
export class Clouds {
  ...
  // Egyptian sky (canon Vol. III: clouds are rare — clear sky, occasional
  // thin cirrus, sparse fair-weather cumulus): seasoning, not cover
  readonly coverage = uniform(0.22);
